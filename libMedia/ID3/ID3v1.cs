...
namespace libMedia.ID3
{
    ...
    public class ID3v1
    {
        ...
        private TagModel GetFrameModel()
        {
            ...
            frameText.TextCode = Utils.TextCode.Ascii;
            ...
            frameFullText.TextCode = Utils.TextCode.Ascii;
        ...
        private static string GetString(Encoding encoding, byte[] tag)
        {
            ...
            int index = Utils.Memory.FindByte(tag, 0x00, 0);
        ...
        public void Deserialize(Stream stream)
        {
            ...
            if (Utils.Memory.Compare(_id3, idTag) != true)
            ...
            {
                _track = tag[29];
                _comment = encoding.GetString(tag, 0, Utils.Memory.FindByte(tag, 0x00, 0));
            }
            else
            {
                _track = 0;
