...
namespace libMedia.ID3
{
    ...
    public class TagHeader
    {
        ...
        public void Serialize(Stream stream)
        {
            ...
            writer.Write(Utils.Swap.UInt32(Utils.Sync.Safe(_id3RawSize + _paddingSize)));
        }
        ...
        public void SerializeFooter(Stream stream)
        {
            ...
            writer.Write(_id3Revision); // ID3v2 revision, e.g. 0
            writer.Write(_id3Flags);    // ID3v2 flags
            writer.Write(Utils.Swap.UInt32(Utils.Sync.Safe(_id3RawSize)));
        }
        ...
        public void Deserialize(Stream stream)
        {
            ...
            if (Utils.Memory.Compare(_id3, idTag) == false)
            ...
            _id3RawSize = Utils.Swap.UInt32(Utils.Sync.UnsafeBigEndian(reader.ReadUInt32()));
            if (_id3RawSize == 0)
