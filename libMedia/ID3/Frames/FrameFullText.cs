...
namespace libMedia.ID3.Frames
{
    ...
    public class FrameFullText : FrameBase, IFrameDescription
    {
        ...
        public override void Parse(byte[] frame)
        {
            ...
            _text = Utils.TextBuilder.ReadTextEnd(frame, index, _textEncoding);
        }
        ...
        public override byte[] Make()
        {
            ...
            var language = Utils.TextBuilder.WriteASCII(_language);
            ...
            writer.Write(Utils.TextBuilder.WriteTextEnd(_text, _textEncoding));
