	...
	public class mp3FrameHeader
    {
        ...
        public string VersionLayer
        {
            get
            {
                ...
                case 0: // MPEG 2.5
                {
                    ...
                    default:
                        throw new InvalidFrameException("MPEG Version 2.5 Layer not recognised");
                    }
                }
                case 2: // MPEG 2
			    {
                    ...
                    default:
					    throw new InvalidFrameException("MPEG Version 2 (ISO/IEC 13818-3) Layer not recognised");
				    }
			    }
			    case 3: // MPEG 1
			    {
                    ...
                    default:
					    throw new InvalidFrameException("MPEG Version 1 (ISO/IEC 11172-3) Layer not recognised");
				    }
			    }
                default:
				    throw new InvalidFrameException("MPEG Version not recognised");
			    }
            }
        }
        ...
        public uint Layer
        {
            get
            {
                ...
                case 3: // Layer I
                    return 1;
                default:
                    throw new InvalidFrameException("MPEG Layer not recognised");
                }
            }
        }
        ...
        public uint? BitRate
        {
            get
            {
                ...
                case 0: // MPEG 2.5
                {
                    ...
                    default:
                        throw new InvalidFrameException("MPEG Version 2.5 BitRate not recognised");
                    } 
                    break;
                }
                case 2: // MPEG 2
			    {
                    ...
                    case 3: // Layer I
                        retval = V2L1[RawBitRate]; break;
                    default:
					    throw new InvalidFrameException("MPEG Version 2 (ISO/IEC 13818-3) BitRate not recognised");
                    } 
                    break;
			    }
			    case 3: // MPEG 1
			    {
                    ...
                    default:
					    throw new InvalidFrameException("MPEG Version 1 (ISO/IEC 11172-3) BitRate not recognised");
                    } 
                    break;
			    }
                default:
                ...
                if (retval == uint.MaxValue)
                    throw new InvalidFrameException("MPEG BitRate not recognised");
                else if (retval == 0)
                    return null;
                else
                    return retval * 1000;
        ...
        public uint SamplesPerSecond
        {
            get
            {
                ...
                if (retval == uint.MaxValue)
                    throw new InvalidFrameException("MPEG SampleFreq not recognised");
                else
                    return retval;
            }
        }
                ...
                case 2: // MPEG 2
                    {
                        ...
                        default:
                            throw new InvalidFrameException("MPEG 2 Layer not recognised");
                        }
                    }
                case 3: // MPEG 1
                    {
                        ...
                        case 3: // Layer I
                            ...
                            return (12 * bitRate.Value / SamplesPerSecond + (uint)(RawPadding ? 1 : 0)) * 4;
                        default:
                            throw new InvalidFrameException("MPEG 1 Layer not recognised");
                        }
                    }
                default:
                    throw new InvalidFrameException("MPEG Version not recognised");
        ...
        public mp3FrameHeader(byte[] frameHeader)
        {
        ...
        bool IsCompatible( mp3FrameHeader destHeader )
        {
