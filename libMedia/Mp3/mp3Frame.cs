...
namespace libMedia.Mp3
{
    ...
    public class mp3Frame
    {
        ...
        /// </summary>
        protected mp3FrameHeader _header;
        ...
        public mp3Frame(byte[] frameBuffer)
        {
            // find and parse frame header, rewind stream to start, or throw.
            _header = new mp3FrameHeader(frameBuffer);
        ...
        public mp3Frame(Stream stream, mp3FrameHeader header, uint frameSize, uint remainingBytes)
        {
        ...
        protected mp3Frame(mp3Frame other)
        {
